...
// Méthode pour ajouter des patients
    public function add():bool{
        try{ 
            ...
            'INSERT INTO `patients`(`lastname`, `firstname`, `birthdate`, `phone`, `mail`), `appointments`(`idPatients`)
                VALUES (:lastname, :firstname, :birthdate, :phone, :mail, :idPatients);'
            );
...
// Méthode pour afficher la liste des patients
    public static function listPatient(string $search = '', $patientsPerPage = '111', $offset = ''):array{ 
