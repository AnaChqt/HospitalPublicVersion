                    ...
                    <div class="card">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-4">
                                ...
                                name="lastname"
                                type="text"
                                value="<?= $idProfil -> lastname ?? $lastname ?? '' ?>" 
                                required
                                pattern="<?=REGEX_NAME?>"                   
                                class="form-control" 
                                id="lastname" 
                            ...
                            <div class="col-md-4">
                                ...
                                name="firstname" 
                                type="text" 
                                value="<?= $idProfil -> firstname ?? $firstname ?? '' ?>"
                                required
                                pattern ="<?=REGEX_NAME?>" 
                                class="form-control" 
                                id="firstname" 
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-4">
                                ...
                                name="birthdate"
                                type="date"
                                value="<?= $idProfil -> birthdate ?? $birthdate ?? '' ?>"
                                required 
                                class="form-control" 
                                id="birthdate"
                                min="1900-01-01"> 
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-4">
                                ...
                                <input name="date" 
                                type="date" 
                                value="<?= $idProfil->date ?? date('Y-m-d', strtotime($result -> dateHour)) ?? '' ?>" 
                                required 
                                class="form-control" 
                                id="date" 
                                min="<?= date('Y-m-d') ?>">
                            ...
                            <div class="col-md-4">
                                <label for="time" class="fw-bold">Choisir un horaire* (Ouvert de 7h30 à 20h)</label>
                                    ...
                                    step="900" 
                                    required 
                                    value="<?= $idProfil->time ?? date('H:i', strtotime($result -> dateHour)) ?? '' ?>" 
                                    pattern="<?=REGEX_TIME?>"                   
                                    class="form-control" 
                                    id="time" 
                                    min="7:30" max="20:00">
